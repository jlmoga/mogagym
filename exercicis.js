...
const CATALEG_EXERCICIS = [
    ...
    },
    {
        ...
        materials: ["gomes"],
        repeticions_suggerides: "3 sèries de 12 repeticions per costat",
        instruccions: "Ancori la goma en un punt alt lateralment. Amb les dues mans, estira la goma en diagonal cap avall fins al maluc contrari, rotant el tors i els peus de manera coordinada.",
